        ...
        **generation_kwargs: dict[str, Any],
        ...
        with torch.autocast(
            ...
            if "alpha" in generation_kwargs:
                logit_processor = TopH_LogitsProcessor(top_n = 100, temperature = generation_kwargs["temperature"], alpha = generation_kwargs["alpha"])
                generation_kwargs.pop("alpha", None)
